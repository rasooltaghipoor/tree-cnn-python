...
tree = TreeCNN(init_classes, ds_name='cifar10')

# from tensorflow.keras.datasets import cifar10
# (x_train, y_train), (x_test, y_test) = cifar10.load_data()


# indice = (y_train<num_initial_classes).flatten()
# indice2 = (y_train<num_initial_classes)
# indice2 = indice2.flatten()
...
Y_true = old_classes_Ytest # y_train[y_train<num_initial_classes]
print(Y_hat)
